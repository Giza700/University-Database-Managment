...
public class CourseList {
    ...
    CourseList(BorderPane borderPane, ToolBar toolBar) {
        window = borderPane;
    ...
    private void setWindowCenter() {
        ...
        DataBaseManagement.getInstance().createTable("RegistrarAccount",// use ur normalized table form
        ...
        try {
            searchResults.setItem(DataBaseManagement.getInstance().fetchColumnsFromRegistrarAccount("*")); // remember
